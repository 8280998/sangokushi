...
quest.py:自动讨伐据点 2025-02-25更新适用代码，原代码重命名为quest_old.py

bonus.py:自动领取每日奖励 2025-02-25更新已取消这个活动

yellow.py：自动打黄巾活动 2025-02-25更新已取消这个活动
...
autoyellow.sh:黄巾活动循环脚本。 2025-02-25更新已取消这个活动

dongzhou.py：新增魔王降临脚本 2025-02-25更新已取消这个活动
